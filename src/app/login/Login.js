...
const Login = () => {
    ...
    return (
        <Box display={"flex"} alignItems={'center'} justifyContent={'center'} width={"100%"} h={"calc(100vh - 60px)"} bg={"linear-gradient(7deg, rgba(253,255,190,1) 0%, rgba(51,148,215,1) 100%)"}>
            <Box borderRadius={"5px"} p={5} bg={"#fff"} boxShadow={"2px 4px 10px 0px rgba(148,148,148,0.56)"} maxW={"400px"} width={"100%"}>
                <VStack spacing={6}>
                    ...
                    <HStack>
                        <Text as={"a"} _hover={{cursor:"pointer"}} fontWeight={700} color={"#3394d7"}>
                            Sign Up
                        </Text>
                        <Text>
